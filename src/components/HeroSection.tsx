...
export default function HeroSection() {
  return (
    <section className="relative overflow-hidden">
      ...
      {/* Content */}
      <div className="relative z-10 container py-16 md:py-24 text-center">
        <div className="max-w-3xl mx-auto space-y-6 text-white">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mt-6">
            ...
            <Button
              ...
              size="lg"
              variant="outline"
              className="bg-white text-black border border-white hover:bg-white hover:text-black focus:text-black active:text-black dark:bg-white dark:text-black dark:hover:text-black transition-all duration-200"
            >
